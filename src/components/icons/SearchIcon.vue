...
<template>
    <div class="contents sm:hidden">
        <button v-if="toggleStore.isSearchShown" type="button" class="h-6 w-6 lg:hidden flex items-center justify-center rounded-md transition hover:bg-black/5 dark:hover:bg-white/10" aria-label="Hide Searchbar" @click="hideSearchbar">
