...
<template>
    <div class="contents sm:hidden">
        <button v-if="toggleStore.isSearchShown" type="button" class="flex h-6 w-6 items-center justify-center rounded-md transition hover:bg-zinc-900/5 focus:bg-zinc-900/10 dark:hover:bg-light/5 dark:focus:bg-light/10 lg:hidden" aria-label="Hide Searchbar" @click="hideSearchbar">
        ...
        <button v-else type="button" class="flex h-6 w-6 items-center justify-center rounded-md transition hover:bg-zinc-900/5 focus:bg-zinc-900/10 dark:hover:bg-light/5 dark:focus:bg-light/10 lg:hidden" aria-label="Show Searchbar" @click="showSearchbar">
