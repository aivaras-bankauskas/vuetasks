...
<template>
    <ul role="list" class="my-10 mx-6 lg:mx-0 pb-36 lg:pb-0 link">
                    ...
                    <li v-for="(parent, parentIndex) in navigationRoutes" :key="parentIndex" class="relative">
                        ...
                        <ul role="list">
                            <li v-for="(child, childIndex) in parent.children" :key="childIndex">
                                <NavigationLink
                                    class="navbar-upper-link hover:text-primary"
        ...
        <li class="xxs:hidden my-3">
            <NavigationLink title="Account" link-to="/account" class="navbar-lower-link hover:text-primary">
        ...
        <li class="lg:hidden my-3">
            <NavigationLink title="API" link-to="/api" class="navbar-lower-link hover:text-primary">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
        ...
        <li class="lg:hidden my-3">
            <NavigationLink title="Documentation" link-to="/documentation" class="navbar-lower-link hover:text-primary">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
        ...
        <li class="lg:hidden mt-10">
            <NavigationLink title="Sign Out" link-to="/sign-out" class="navbar-lower-link text-danger hover:text-danger-light" active-text="text-danger">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
...
.navbar-lower-link {
    @apply flex gap-x-3 justify-start items-center text-sm leading-5;
}
</style>
